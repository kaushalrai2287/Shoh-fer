...
const formSchema = z.object({
  ...
  roll_name: z.string().min(1, "Role Name is required"), //
  password: z
    .string()
...
const SystemSetting = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    //   console.log("Email check response JSON:", emailCheck);
      ...
      if (userError) {
        toast.error(
          "Error inserting into custom users table: " + userError.message
        );
        return;
      }
  ...
  const handleClose = (event: { preventDefault: () => void }) => {
    ...
    router.push("/rolls-permission/list"); 
  };
        ...
        <div className="inner_right">
          ...
          <div className="add_service_formbox checkbox_formbox">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="service_form_heading">Assign Permissions</div>
