  ...
  let encryptedPassword = null;
     ...
     // Use the generated public UR
      ...
      if (error) {
        ...
        if (error.code === '23505') { // Example for duplicate key error (unique constraint violation)
          alert("Duplicate entry error. A service center with the same identifier already exists.");
        } else if (error.code === '22001') { // Example for string too long error
          alert("One of the fields exceeds the maximum length. Please check your inputs.");
        } else {
          alert(`An error occurred while updating the service center: ${error.message}`);
        }
        return;
      }
                ...
                <div className="inner_right">
                    <div className="add_service_formbox">
                        <form action="" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="inner_form_group">
                                <label htmlFor="business_registration_no">Registration Number</label>
                                <input className="form-control" type="text" {...register("business_registration_no")} id="business_registration_no" />
                                {errors.business_registration_no && (
                                    <p className="erro_message">{errors.business_registration_no.message}</p>
                                )}
                            </div>
                            <div className="inner_form_group">
  ...
  <div className="down_arrow_btn">
    <img src="/images/angle-small-down.svg" alt="Arrow" className="img-fluid" />
                      ...
                      <p className="erro_message">{(errors.document_upload as FieldError).message}</p>
                            ...
                            <div className="inner_form_group">
                                <label htmlFor="primary_contact_person">Contact Person <span>*</span></label>
                                <input className="form-control" type="text" {...register("primary_contact_person")} id="primary_contact_person" />
                                {errors.primary_contact_person && (
                                    <p className="erro_message">{errors.primary_contact_person.message}</p>
                                )}
                            </div>
                            <div className="inner_form_group">
                            ...
                            <div className="inner_form_group">
                                ...
                                <textarea className="form-control" {...register("address")} id="address" rows={1}></textarea>
                                {errors.address && (
